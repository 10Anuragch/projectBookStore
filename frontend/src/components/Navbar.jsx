...
function Navbar() {
  ...
  // React Hook  - Hooks are functions in react that allow us to manage state , do
  // change as per the state , and other react features without using class components. they provide a way to reuse stateful logic across components.
  // 1.useState():-it is used to manage and update state.
  // 2.useEffect():-the useEffect hook is used for handling side effect during component mount,update and unmount
  ...
  },[])//empty array[] is a dependency so that useEffect baar baar mount na ho.
  const navItems = (
    <>
      <li>
        <a href="/">Home</a>
